...
#print(spacex_df['Launch Site'].value_counts().head())

# Create a dash application
app = dash.Dash(__name__)

# Create an app layout
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard (Te amo bebe)',
...
def get_scatter(entered_site,value):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(spacex_df.loc[(spacex_df['Payload Mass (kg)']>=value[0])&
